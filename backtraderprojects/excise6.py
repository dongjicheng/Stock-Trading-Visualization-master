...
class ssa_index_ind(bt.Indicator):
    ...
    def next(self):
        ...
        print(self.data.get(1),self.data_0.get(1),self.data_1.get(1),self.data_2.get(1),self.data_3.get(1),self.data_4.get(1),self.data_5.get(1))
        print(self.data.get(1), self.data0_0.get(1), self.data0_1.get(1), self.data0_2.get(1), self.data0_3.get(1),
              self.data0_4.get(1), self.data0_5.get(1))
        print(self.data.get(1), self.data_open.get(1), self.data_close.get(1), self.data_high.get(1), self.data_low.get(1),
              self.data_volume.get(1))
...
class MyStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.ssa = ssa_index_ind(ssa_window=self.params.ssa_window, subplot=True)
